...
class RealtimeDataExample(object):
    ...
    def authentication_on_open(self, _websocket) -> None:
        ...
        self.return_message['auth'] = 'AUTH_OPENED'
    ...
    def authentication_on_error(self, websocket, error: str) -> None:
        ...
        if websocket.keep_running:
            ...
            self.return_message['auth'] = 'AUTH_ERROR'
    ...
    def authentication_on_close(self, _websocket) -> None:
        ...
        self.return_message['auth'] = 'AUTH_CLOSED'
    ...
    def realtime_situation_on_message(self, _websocket, message: str) -> None:
        ...
        node_message = {}
        if wnt_message.HasField("online_status") or wnt_message.HasField("node_metadata") or wnt_message.HasField("rx_time") or wnt_message.HasField("tx_time"):
            ...
            node_message['time2'] = wnt_message.online_status.last_time_series_write
    ...
    def run(self) -> int:
        ...
        try:
            ...
            self.realtime_situation_thread.join(0)
        ...
        return {'code':self.return_code, 'message': self.return_message['tags']}


if __name__ == "__main__":

    results = RealtimeDataExample().run()
    ...
    while True:
        if len(result_message):
            ...
            with open("./wirepas_realtime_status.txt", 'w') as data:
                data.write('UNLOCKED')
            with open("./wirepas_tags_msg.txt", 'w') as data:
                data.write('')
            with open("./wirepas_tags_msg.txt", 'w') as data:
                data.write(json.dumps(result_message))
            exit(result_code)
